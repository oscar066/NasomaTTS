...
export default function SummaryPanel() {
  ...
  const generate = () => {
    ...
    setTimeout(() => {
      setSummary(
        "Summary generation will be connected to your document shortly. This will provide a concise overview of the key points, themes, and narrative arc."
      );
      setLoading(false);
    }, 1200);
  };
  ...
  return (
    <div className="flex flex-col gap-3 h-full px-5 pb-5 min-h-0">
      <ScrollArea className="flex-1">
        <p className="text-sm text-foreground leading-relaxed whitespace-pre-wrap pr-2">{summary}</p>
      </ScrollArea>
