...
import { LogIn, Loader2, AlertCircle, MessageSquare, FileText, HelpCircle, History } from "lucide-react";
import Link from "next/link";
import { BsEyeFill, BsEyeSlashFill } from "react-icons/bs";
import NasomaLogo from "@/app/components/Logo/nasoma-logo";

const features = [
  { icon: MessageSquare, text: "Chat with your document" },
  { icon: FileText,      text: "Instant AI summaries" },
  { icon: HelpCircle,   text: "Comprehension quizzes" },
  { icon: History,      text: "Reading recaps" },
];
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary to-purple-700 flex-col justify-between p-12 text-white overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-bold mb-4 leading-snug">
            Read deeper,<br />understand more.
          </h2>
          <p className="text-white/80 mb-8 leading-relaxed">
            Audio and visual highlighting in sync, plus AI tools that help
            you concentrate, comprehend, and cover more of what matters.
          </p>
        ...
        <div className="relative z-10 border-t border-white/20 pt-6">
          <p className="text-sm text-white/70 italic">
            &ldquo;I retain so much more now. The AI recap alone is worth it.&rdquo;
          </p>
